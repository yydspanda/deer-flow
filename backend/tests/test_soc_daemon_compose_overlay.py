...
def test_soc_daemon_compose_overlay_is_explicit_opt_in() -> None:
    ...
    assert "SOC_LLM_CALL_TIMEOUT_SECONDS=${SOC_LLM_CALL_TIMEOUT_SECONDS:-180}" in overlay
    assert "SOC_LLM_SENSITIVE_EVIDENCE_MODE=${SOC_LLM_SENSITIVE_EVIDENCE_MODE:-redact}" in overlay
