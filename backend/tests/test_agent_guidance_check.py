...
EXPECTED_GUIDANCE_PATHS = {
    "AGENTS.md",
    "backend/AGENTS.md",
    "backend/soc_agent/AGENTS.md",
    "backend/soc_agent/integrations/pingan/AGENTS.md",
    "backend/soc_agent/memory/AGENTS.md",
    "frontend/AGENTS.md",
    ...
    "frontend/src/app/workspace/soc/AGENTS.md",
    "scripts/AGENTS.md",
...
def test_local_guidance_files_contain_the_split_original_sections() -> None:
    expected_headings = {
        ...
        "backend/soc_agent/AGENTS.md": "## Ownership Boundaries",
        "backend/soc_agent/integrations/pingan/AGENTS.md": "## Input And Normalization",
        "backend/soc_agent/memory/AGENTS.md": "## Lifecycle",
        "frontend/src/AGENTS.md": "### Data Flow",
        "frontend/src/app/workspace/soc/AGENTS.md": "## API And Navigation",
        "validation/AGENTS.md": "## Data And Safety",
    }
