...
def test_runtime_environment_switch_applies_stg_zeus_target_atomically(
    tmp_path: Path,
) -> None:
    ...
    assert "export SOC_PINGAN_WORKFLOW_APP_SECRET='workflow-secret'" in rendered
...
def test_runtime_environment_switch_applies_prd_zeus_target_for_dev(
    tmp_path: Path,
) -> None:
