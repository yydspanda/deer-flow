...
class SocMutationOperation(StrEnum):
    ...
    MEMORY_DRAFT_SAVE = "memory.draft_save"
    MEMORY_DRAFT_GENERATE = "memory.draft_generate"
    MEMORY_DRAFT_GENERATED = "memory.draft_generated"
    MEMORY_RUN_PROMOTE = "memory.run_promote"
    MEMORY_CANDIDATE_SUPERSEDE = "memory.candidate_supersede"
