...
def explain_scope_facets(spec: SocMemoryApplicabilitySpec, facets: dict[str, list[str]]) -> dict[str, dict[str, list[str]]]:
    ...
    version = {"pingan.soc.memory_features.v5": "v5", "pingan.soc.memory_features.v6": "v6", "pingan.soc.memory_features.v7": "v7", "pingan.soc.memory_features.v8": "v8"}.get(spec.feature_schema_version)
    if version is None:
        return result
