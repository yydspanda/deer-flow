...
def load_pingan_endpoint_playbooks_profile() -> TenantKnowledgeProfile:
    return load_tenant_knowledge_profile(Path(__file__).with_name("endpoint-playbooks-v1.json"))
