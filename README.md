...
> Experience matching preserves existing entity identities and the 512-character condition limit.
> New experience learning excludes oversized entity values from proposed matching features and the
> optional-condition directory, while retaining full evidence. Remaining features must pass the
