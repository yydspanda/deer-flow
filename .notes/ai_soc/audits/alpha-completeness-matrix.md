...
| `AC-40` | Correction and review-note Memory admission | Complete | - | Both pass `MemoryAdmissionService`; ordinary notes/corrections remain `observed_only` unless an explicit human promotion, substantive reason and reusable facet all pass | Maintain |
