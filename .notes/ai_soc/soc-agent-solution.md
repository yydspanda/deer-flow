...
4. Current：Memory Tracking Contract / DB-first candidate persistence，补 `SocMemoryRecord`、`SocMemoryFact`、`SocMemoryEvidenceRef`、`SocMemoryQuery`、`SocMemoryStatus`、review/confirm/reject/deprecate 状态机。
