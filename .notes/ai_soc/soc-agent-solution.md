...
真实 Kafka consumer adapter 规划见 `.notes/ai_soc/kafka-consumer-adapter-plan.md`。下一刀优先补 supervisor/Docker entrypoint 约定、healthcheck、日志采集和隔离 topic smoke，避免默认 topic 历史消息干扰验收。
