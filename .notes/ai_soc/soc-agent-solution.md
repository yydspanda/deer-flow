...
[Done] Phase 1 reliable runtime / review / approval / Kafka baseline
  ...
  -> [Partial] Generic security scenario recognition deterministic MVP: evidence fusion + current conclusion + vendor.unmapped fallback + taxonomy eval baseline; bounded LLM recognizer/custom taxonomy pending
```
