...
- Chat entry：
  ...
  - 当前已新增 `backend/soc_agent/mcp_adapters.py` skeleton：固定 `SocMcpToolProviderPort`、`SocMcpToolActionAdapter`、read-only MCP descriptor helper 和 fake-provider tests；尚未接真实 DeerFlow cached MCP provider。
