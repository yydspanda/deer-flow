...
| 执行当前 PI-01D4 shadow report/telemetry/addendum；或补跑 PI-01A/B1、恢复 D12-B 内网验收 | `delivery-roadmap.md` 的 PI-01D 分解 | `integrations/pingan-internal-continuation-handoff.md` |
