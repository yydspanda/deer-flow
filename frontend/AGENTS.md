...
SOC workspace pages additionally follow
`src/app/workspace/soc/AGENTS.md`. They are thin clients for server-owned SOC contracts;
do not move vendor parsing, Runtime decisions, Memory construction, policy evaluation,
or action authority into React.
